...
import (
	...
	"github.com/sdurz/trackerbot/lockdispatcher"
...
var (
	...
	lrucache   *lru.Cache
	dispatcher *lockdispatcher.LockDispatcher
)
...
func main() {
	...
	bot.AddMessageHandler(ubot.MessageHasCommand("/setprofile"), SetProfileMessageHandler)
	...
	dispatcher = lockdispatcher.NewLockDispatcher(ctx)
